...
public:
    ...
    typedef void (*FillRowCallback)(void *context, int16_t by, uint8_t *row_buf);
...
private:
    ...
    inline void _pwr(CsType cs_type = CsType::CS_MASTER);
    inline void _pof(CsType cs_type = CsType::CS_MASTER);
    inline void _pon(CsType cs_type = CsType::CS_MASTER);
    inline void _drf(CsType cs_type = CsType::CS_MASTER);
    inline void _cdi(CsType cs_type = CsType::CS_MASTER);
    inline void _tcon(CsType cs_type = CsType::CS_MASTER);
    inline void _tres(CsType cs_type = CsType::CS_MASTER);
    inline void _cmd66(CsType cs_type = CsType::CS_MASTER);
    inline void _en_buf(CsType cs_type = CsType::CS_MASTER);
    inline void _ccset(CsType cs_type = CsType::CS_MASTER);
    inline void _pws(CsType cs_type = CsType::CS_MASTER);
    inline void _an_tm(CsType cs_type = CsType::CS_MASTER);
    inline void _agid(CsType cs_type = CsType::CS_MASTER);
    inline void _btst_p(CsType cs_type = CsType::CS_MASTER);
    inline void _btst_n(CsType cs_type = CsType::CS_MASTER);
    inline void _boost_vddp_en(CsType cs_type = CsType::CS_MASTER);
    inline void _buck_boost_vddn(CsType cs_type = CsType::CS_MASTER);
